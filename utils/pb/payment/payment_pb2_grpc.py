...
from utils.pb.payment import payment_pb2 as payment__pb2
...
class PaymentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Prepare = channel.unary_unary(
                '/utils.pb.payment.PaymentService/Prepare',
        ...
        self.Commit = channel.unary_unary(
                '/utils.pb.payment.PaymentService/Commit',
        ...
        self.Abort = channel.unary_unary(
                '/utils.pb.payment.PaymentService/Abort',
...
def add_PaymentServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'utils.pb.payment.PaymentService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('utils.pb.payment.PaymentService', rpc_method_handlers)
